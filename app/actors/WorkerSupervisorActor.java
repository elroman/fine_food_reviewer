...
public class WorkerSupervisorActor
    ...
    public PartialFunction<Object, BoxedUnit> receive() {
        return LoggingReceive.create(ReceiveBuilder
                ...
                .match(SparkStartParseCmd.class, this::sparkStartParse)
    ...
    private void sparkStartParse(SparkStartParseCmd cmd) {
        logger.debug("Parse file started with spark");
        parseFileService.countWord(PATH_TO_FILE);
    }
